...
class MaxEntropyEnrichment_qualitative(MaxEntropyEnrichment):
    ...
    def optimise(self):
        ...
        # compute vector of feature values
        self.log("Computing vector of all feature values", lg.INFO)
        self.feature_values = functions.infer_modalities_from_distributions(self.distributions)
    ...
    def _compute_feature_prob(self, attribute, modality):
        ...
        #total_population_decile_tmp = [ # Modified by POV
        #    float(decile_tmp["D1"]),
        #    float(decile_tmp["D2"]),
        #    float(decile_tmp["D3"]),
        #    float(decile_tmp["D4"]),
